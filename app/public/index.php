...
$app->post('/plus-product', CartProductController::class, 'plusProduct', PlusProductRequest::class);
$app->post('/minus-product', CartProductController::class, 'minusProduct', MinusProductRequest::class);
