...
class PlacedOrder extends Model
{
    ...
    {
        $statement = $this->pdo->prepare("INSERT INTO placed_orders (total, email, phone, name, address, city, country, postal) VALUES (:total, :email, :phone, :userName, :address, :city, :country, :postal)");
